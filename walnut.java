...
public class walnut implements actor{
    ...
    public walnut(Group root /*,Player player*/) throws FileNotFoundException{
        //this.player = player;
    	this.hBox=new HBox();
    	
        this.posx=580;
        this.posy=170;
        this.plant = new Image(new FileInputStream("C:\\Users\\HARSHIT\\Desktop\\walnut.gif"));
