...
public class football implements Zombie {
    private int posx;
    private int posy;
    ...
    public football(Group root,int posx,int posy) throws FileNotFoundException {
    	this.hBox=new HBox();
        this.posx = posx;
        this.posy = posy;
        this.zombie = new Image(new FileInputStream("C:\\Users\\HARSHIT\\Desktop\\zombie_football.gif"));
