...
private void refreshScene1() {
	...
	public void start(Stage stage) {
		try {
			...
			normalzombie normal=new normalzombie(root,1100,75);
			...
			/*scene.getStylesheets().add(getClass().getResource("application.css").toExternalForm());*/
		      ...
		      root = new Group(imageView1,imageView2,imageView4,imageView5,imageView6,imageView7,imageView8,imageView9,imageView10,imageView13,imageView14,imageView18,normal.getigw(),vBox,sphere);
