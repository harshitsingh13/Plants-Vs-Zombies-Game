...
private void refreshScene1() {
	...
	public void start(Stage stage) {
		try {
			...
			football foot1=new football(root,900,75);
			football foot2=new football(root,900,195);
			football foot3=new football(root,900,295);
			football foot4=new football(root,900,395);
			football foot5=new football(root,900,495);
			barrier br1=new barrier(root,820,65);
			barrier br2=new barrier(root,820,185);
			barrier br3=new barrier(root,820,285);
			barrier br4=new barrier(root,820,385);
			barrier br5=new barrier(root,820,485);
			king king1=new king(root,720,75);
			king king2=new king(root,720,195);
			king king3=new king(root,720,295);
			king king4=new king(root,720,395);
			king king5=new king(root,720,495);
			 ...
			 //////////////////////////////////////////////////////////////////////////////////////////// 
			   ...
			   ///////////////////////////////////////////////////////////////////////////////////////
			     ...
			     Path paths=new Path();
			      ...
			      pathTransitions.setDuration(Duration.seconds(5));
			      //
			      //
			...
			/*scene.getStylesheets().add(getClass().getResource("application.css").toExternalForm());*/
			     VBox vBox = new VBox();
			        vBox.getChildren().addAll(hBox15,hBox1,hBox12,hBox14,hBox13,peashooter.gethbox(),sunflower.gethbox(),walnut.gethbox(),beetroot.gethbox(),potato.gethbox(),threepea.gethbox());
			       //root.getChildren().addAll(vBox);
		      root = new Group(imageView1,imageView2,imageView4,imageView5,imageView6,imageView7,imageView8,imageView9,imageView10,imageView13,imageView14,imageView18,normal1.getigw(),normal2.getigw(),normal3.getigw(),normal4.getigw(),normal5.getigw(),s1.getigw(),s2.getigw(),s3.getigw(),s4.getigw(),s5.getigw(),cap1.getigw(),cap2.getigw(),cap3.getigw(),cap4.getigw(),cap5.getigw(),news1.getigw(),news2.getigw(),news3.getigw(),news5.getigw(),news4.getigw(),foot1.getigw(),foot2.getigw(),foot3.getigw(),foot4.getigw(),foot5.getigw(),br1.getigw(),br2.getigw(),br3.getigw(),br4.getigw(),br5.getigw(),king1.getigw(),king2.getigw(),king3.getigw(),king4.getigw(),king5.getigw(),vBox,sphere);
