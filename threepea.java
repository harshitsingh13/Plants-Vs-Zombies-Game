...
public class threepea implements actor{
    ...
    public threepea(Group root /*,Player player*/) throws FileNotFoundException{
        //this.player = player;
    	this.hBox=new HBox();
    	
        this.posx=980;
        this.posy=-100;
        this.plant = new Image(new FileInputStream("C:\\Users\\HARSHIT\\Desktop\\threepea.gif"));
