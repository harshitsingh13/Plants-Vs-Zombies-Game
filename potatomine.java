...
public class potatomine implements actor{
    ...
    public potatomine(Group root /*,Player player*/) throws FileNotFoundException{
        //this.player = player;
    	this.hBox=new HBox();
    	
        this.posx=860;
        this.posy=-10;
        this.plant = new Image(new FileInputStream("C:\\Users\\HARSHIT\\Desktop\\potato.gif"));
